...
`)+`
`+b);const A=x+d+o,D=x+b+a,R=Ma(r,r.VERTEX_SHADER,A),w=Ma(r,r.FRAGMENT_SHADER,D);r.attachShader(f,R),r.attachShader(f,w),t.index0AttributeName!==void 0?r.bindAttribLocation(f,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(f,0,"position"),r.linkProgram(f);function k(W){if(i.debug.checkShaderErrors){const Q=r.getProgramInfoLog(f).trim(),C=r.getShaderInfoLog(R).trim(),z=r.getShaderInfoLog(w).trim();let H=!0,X=!0;if(r.getProgramParameter(f,r.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,f,R,w);else{const V=Ea(r,R,"vertex"),G=Ea(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(f,r.VALIDATE_STATUS)+`
