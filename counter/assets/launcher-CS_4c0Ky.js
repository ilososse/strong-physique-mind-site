...
`)+`
`+b);const A=S+f+o,D=S+b+a,R=Ta(s,s.VERTEX_SHADER,A),w=Ta(s,s.FRAGMENT_SHADER,D);s.attachShader(p,R),s.attachShader(p,w),t.index0AttributeName!==void 0?s.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(p,0,"position"),s.linkProgram(p);function W(X){if(i.debug.checkShaderErrors){const ee=s.getProgramInfoLog(p).trim(),C=s.getShaderInfoLog(R).trim(),H=s.getShaderInfoLog(w).trim();let z=!0,q=!0;if(s.getProgramParameter(p,s.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,p,R,w);else{const G=Aa(s,R,"vertex"),V=Aa(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(p,s.VALIDATE_STATUS)+`
